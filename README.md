...
- **Hashtag bypass** — Posts with science-relevant hashtags (`#neuroscience`, `#cogsci`, `#neurobrain`, `#neuroskyence`, and ~20 others) skip the keyword prefilter but still go through the LLM classifier. This catches posts by scientists who don't happen to use the right vocabulary.
